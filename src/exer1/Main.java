...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("\nA casa vendida na morada " + casa1.getMorada() + " tem uma margem de lucro de "+ casa1.getMargemLucro() + "€" +
		...
		System.out.println("\nA casa vendida na morada " + casa2.getMorada() + " tem uma percentagem de margem de lucro de " + casa2.getPercentMargemLucro() + "%");
