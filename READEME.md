Neste projeto foram criados as classes Banco, ContaBancaria, Casa e Main para correr o programa.
...
Na classe Banco foram criados fields(privados) morada, precoCusto e precoVenda. Os métodos desta classe utilizados são getMargemLucro e getPercentMargemLucro.
...
Em relação à casa, o programa permite calcular a margem de lucro da venda de uma casa, tanto em unidades monetárias, como em percentagem. A classe casa está interligada ao banco com a morada.
